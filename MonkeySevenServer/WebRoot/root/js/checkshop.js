		...
		$.ajax({
			...
			success : function(data) {
				...
				$("#shop").append('<tr>'+
										...
										'<td style="text-align: center;" >'+'<a href="shopmessage.html?id='+shops[i].id+'" >详情</a>'+'</td>'+
	'<td style="text-align: center;" >'+'<button class="btn btn-primary btn-xs" data-toggle="modal" onclick="shopid='+shops[i].id+'" id="del" data-target="#myModal">删除'+
										'</button>'+'</td>'+
										'</tr>' );
				}
				if(data.count!=0){
