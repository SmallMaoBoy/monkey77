...
public class TCartId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return ((this.getUserId() == castOther.getUserId()) || (this
				...
				&& ((this.getGoodNumber() == castOther.getGoodNumber()) || (this
						.getGoodNumber() != null
						&& castOther.getGoodNumber() != null && this
						.getGoodNumber().equals(castOther.getGoodNumber())));
	}
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getGoodNumber() == null ? 0 : this.getGoodNumber()
						.hashCode());
		return result;
	}
